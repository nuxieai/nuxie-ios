...
final class NuxieContextBuilderTests: AsyncSpec {
    ...
    override class func spec() {
        ...
        func awaitEnriched(
            ...
            customProperties: sending [String: Any] = [:]
        ) async -> [String: Any] {
            await builder.buildEnrichedProperties(customProperties: customProperties)
        }
        ...
        describe("NuxieContextBuilder") {
            ...
            describe("buildEnrichedProperties") {
                ...
                it("should include all context layers") {
                    ...
                    let enriched = await awaitEnriched(contextBuilder, customProperties: customProperties)
            ...
            describe("user context") {
                ...
                it("should handle nil identity service") {
                    ...
                    let enriched = await awaitEnriched(builderWithoutIdentity)
