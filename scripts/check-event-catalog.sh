...
is_allowlisted_catalog_site() {
  case "$1|$2" in
    '$journey_converted|Sources/Nuxie/Events/EventLog.swift:1956' \
      ...
      | '$feature_used|Sources/Nuxie/Features/FeatureUseCommandQueue.swift:478')
      return 0
      ;;
    *)
      return 1
...
catalog_event_emitters_for_indirect_emission_site() {
  case "$1" in
    ...
    'Sources/Nuxie/Events/EventLog.swift:1956')
      ...
      ;;
    'Sources/Nuxie/Features/FeatureUseCommandQueue.swift:478' \
      | 'Sources/Nuxie/Features/FeatureUseCommandQueue.swift:628' \
...
$feature_used\tfeatureCommand\tSources/Nuxie/Features/FeatureUseCommandQueue.swift:478
$feature_used\tstorePreparedEventInHistory\tSources/Nuxie/Features/FeatureUseCommandQueue.swift:628
