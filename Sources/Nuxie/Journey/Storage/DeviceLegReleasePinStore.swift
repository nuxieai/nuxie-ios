...
struct DeviceLegReleasePinReferences: Sendable {
...
struct DeviceLegReleasePinStore: Sendable {
    ...
    func prepareAdmission(
        ...
        artifactSource: DeviceLegReleaseArtifactSource?,
    ...
    func pinnedArtifacts(
        sha256s: [String]
    ) throws -> DeviceLegPinnedReleaseArtifacts {
    ...
    func removeUnreferenced(
        _ references: DeviceLegReleasePinReferences
    ) throws {
    ...
    func removeGlobalOrphans(
        ...
        referencesForJournal:
            (URL) throws -> DeviceLegReleasePinReferences
    ) throws {
        let fileManager = FileManager.default
