...
enum DeviceLegValues {
    static func resolve(_ value: JourneyValue, context: ArmedDeviceLeg.Context) -> ExperienceReleaseJSONValue? {
        switch value {
    ...
    static func evaluate(_ condition: JourneyCondition, context: ArmedDeviceLeg.Context) -> Bool? {
        switch condition {
    ...
    private static func equal(_ left: ExperienceReleaseJSONValue, _ right: ExperienceReleaseJSONValue) -> Bool {
        switch (left, right) {
