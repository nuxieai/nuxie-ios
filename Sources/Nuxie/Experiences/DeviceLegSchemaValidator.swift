...
/// verifier, but this grammar never reconstructs a legacy journey or chain.
enum DeviceLegSchemaValidator {
    private typealias Common = ExperienceReleaseDescriptorSchemaValidator
    ...
    static func validate(_ value: [String: Any]) throws {
        ...
        guard root["schemaVersion"] as? String == DeviceLegReleaseDescriptor.wireSchemaVersion else { throw invalid }
